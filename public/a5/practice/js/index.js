...
console.log('Square & threePlusOne');
const square = a => a * a;
const plusOne = a => a + 1;
...
console.log('0:',variableArray1.at(0));
console.log('1:',variableArray1.at(1));
console.log('2:',variableArray1.at(2));
console.log('3:',variableArray1.at(3));
console.log('4:',variableArray1.at(4));
