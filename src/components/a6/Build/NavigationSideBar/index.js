    ...
    return(
        <>
            <div className="list-group">
                ...
                <Link to="/a6/twitter/notifications" className={`list-group-item ${active === 'notifications' ? 'active':''}`}>
                    <i className="fas fa-bell" style={{color: "lightgray"}}/>
                    <span className="d-none d-xl-inline-block d-xxl-inline-block list-content"
                          style={{paddingLeft: "5px"}}>Notifications</span>
                </Link>
                <Link to="/a6/twitter/messages" className={`list-group-item ${active === 'messages' ? 'active':''}`}>
                    <i className="fas fa-envelope" style={{color: "lightgray"}}/>
                    <span className="d-none d-xl-inline-block d-xxl-inline-block list-content"
                          style={{paddingLeft: "5px"}}>Messages</span>
                </Link>
                <Link to="/a6/twitter/bookmarks" className={`list-group-item ${active === 'bookmarks' ? 'active':''}`}>
                    <i className="far fa-bookmark" style={{color: "lightgray"}}/>
                    <span className="d-none d-xl-inline-block d-xxl-inline-block list-content"
                          style={{paddingLeft: "5px"}}>Bookmarks</span>
                </Link>
                <Link to="/a6/twitter/lists" className={`list-group-item ${active === 'lists' ? 'active':''}`}>
                    <i className="fas fa-list" style={{color: "lightgray"}}/>
                    <span className="d-none d-xl-inline-block d-xxl-inline-block list-content"
                          style={{paddingLeft: "5px"}}>Lists</span>
                </Link>
                <Link to="/a6/twitter/profile" className={`list-group-item ${active === 'profile' ? 'active':''}`}>
                    <i className="far fa-user-circle" style={{color: "lightgray"}}/>
                    <span className="d-none d-xl-inline-block d-xxl-inline-block list-content"
                          style={{paddingLeft: "5px"}}>Profile</span>
                </Link>
                <Link to="/a6/twitter/more" className={`list-group-item ${active === 'more' ? 'active':''}`}>
            ...
            <div className="d-grid mt-2">
                <Link to="/a6/" className="btn btn-primary btn-block rounded-pill">Tweet</Link>
            </div>
        </>
    );
}
